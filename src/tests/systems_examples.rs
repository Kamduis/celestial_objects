				...
				.with_satellites( vec![
					...
					Orbit {
						...
						body: CelestialBody::Trabant( Trabant {
							...
							techlevel: Some( 10 ),
							network: Network::Datasphere( Plexus::Yes ),
							gates: 14,
							population: Population::from_humans( 1_100_000 ),
							properties: Vec::new(),
							policies: Vec::new(),
							institutions: Vec::new(),
							...
							satellites: vec![
								Orbit {
									...
									body: CelestialBody::Trabant( Trabant {
										...
										network: Network::Datasphere( Plexus::Yes ),
										gates: 1,
										population: Population::from_humans( 300_000 ),
										properties: Vec::new(),
										policies: Vec::new(),
										institutions: Vec::new(),
								...
								Orbit {
									...
									body: CelestialBody::Station( Station {
										...
										network: Network::Datasphere( Plexus::Yes ),
										gates: 0,
										population: Population::from_humans( 8_000 ),
										properties: Vec::new(),
										policies: Vec::new(),
										institutions: Vec::new(),
					...
					Orbit {
						...
						body: CelestialBody::Trabant( Trabant {
							...
							network: Network::Datasphere( Plexus::Yes ),
							gates: 64,
							population: Population::from_humans( 88_040_000 ),
							properties: Vec::new(),
							policies: Vec::new(),
							institutions: Vec::new(),
							military: MilitaryPresence::new_union( Presence::Base ),
							...
							satellites: vec![
								Orbit {
									...
									body: CelestialBody::Trabant( Trabant {
										...
										gates: 0,
										population: Population::from_humans( 1_000 ),
										properties: Vec::new(),
										policies: Vec::new(),
										institutions: Vec::new(),
										military: MilitaryPresence::new_union( Presence::Base ),
							...
							.with_satellites( vec![
								Orbit {
									...
									body: CelestialBody::Trabant( Trabant {
										...
										network: Network::Datasphere( Plexus::Yes ),
										gates: 122,
										population: Population::from_humans( 13_180_000_000 ),
										properties: Vec::new(),
										policies: Vec::new(),
										institutions: Vec::new(),
										military: MilitaryPresence::new_union( Presence::Base ),
							...
							.with_satellites( vec![
								Orbit {
									...
									body: CelestialBody::Trabant( Trabant {
										...
										network: Network::Datasphere( Plexus::Yes ),
										gates: 58,
										population: Population::from_humans( 6_760_000_000 ),
										properties: Vec::new(),
										policies: Vec::new(),
										institutions: Vec::new(),
										military: MilitaryPresence::new_union( Presence::Base ),
