				...
				.with_satellites( vec![
					...
					Orbit {
						...
						body: CelestialBody::Trabant( Trabant {
							...
							policies: Vec::new(),
							institutions: Vec::new(),
							military: MilitaryPresence::new_fleet( Presence::Patrol ),
							satellites: Vec::new(),
						} ),
					},
					Orbit {
							...
							satellites: vec![
								Orbit {
									...
									body: CelestialBody::Trabant( Trabant {
										...
										policies: Vec::new(),
										institutions: Vec::new(),
										military: MilitaryPresence::new_fleet( Presence::Secret ),
										satellites: Vec::new(),
									} ),
								},
								Orbit {
									...
									body: CelestialBody::Station( Station {
										...
										policies: Vec::new(),
										institutions: Vec::new(),
										military: MilitaryPresence::new_fleet( Presence::Base ),
										satellites: Vec::new(),
									} )
								},
							],
							...
							satellites: vec![
								...
								Orbit {
									...
									body: CelestialBody::Trabant( Trabant {
										...
										policies: Vec::new(),
										institutions: Vec::new(),
										military: MilitaryPresence::new_fleet( Presence::Fob ),
										satellites: Vec::new(),
									} ),
								},
							],
